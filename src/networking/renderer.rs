...
use lightyear::prelude::{is_server, PreSpawnedPlayerObject, Replicating, TickManager};

use crate::networking::entity_label::EntityLabel;

use super::protocol::{BallMarker, BulletMarker, ColorComponent, Player, PlayerActions, Score, BULLET_SIZE, SHIP_LENGTH, SHIP_WIDTH};
use super::shared::{Wall, MAX_VELOCITY};

use super::entity_label::{self, EntityLabelPlugin};
